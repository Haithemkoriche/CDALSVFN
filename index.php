...
<body style="scroll:smoth;">
    ...
    <div class="container mb-5 mt-5 pt-5">
      ...
      <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 g-4">
        <?php foreach ($activities as $activity) : ?>
          ...
          <div class="modal fade" id="inscriptionModal<?php echo $activity['ID_act']; ?>" tabindex="-1" role="dialog" aria-labelledby="inscriptionModalLabel<?php echo $activity['ID_act']; ?>" aria-hidden="true" style="translate: -50%;left: 50%;max-width: 100%;">
  ...
  <footer class="mt-5 pb-4">
    <div class="container">
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12792.419703364221!2d2.9482025!3d36.7200412!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x128faf8850f2ce0d%3A0xe04e843394305899!2sCenter%20Development%20Activities%20Scientists%20Ouledfayt%20Cdals!5e0!3m2!1sen!2sdz!4v1681857433561!5m2!1sen!2sdz" class="w-100" height="auto" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    </div>
